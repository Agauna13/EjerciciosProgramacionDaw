...
public class Dinglemouse {
  ...
  public static String whatTimeIsIt(final double angle) {
    ...
    double myAngleWithBlackjackAndHockers = angle;
    
    if(angle == 0){
      myAngleWithBlackjackAndHockers += 360;
      }
       double hours = myAngleWithBlackjackAndHockers / 30;
       double minutes = myAngleWithBlackjackAndHockers%30 * 2;
